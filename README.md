...
<p align="center">
  xasset 是全面可靠的 Unity 资源框架，支持 Android、iOS、Windows、OSx、WebGL等平台。
  <br>
...
使用 xasset 可以更快，更轻松的解决 UNITY 项目的打包慢、包体大、热更新、内存管理和运行卡顿之类的疑难杂症。从发布至今已经持续迭代了近 5 年，我们收获了 1400+ 星标、180+ 订阅用户，并始终在为化繁为简，节省时间的目标发力。
